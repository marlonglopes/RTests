...
# Store the Survived column of train and test in 
train_labels = train$Survived
test_labels  = test$Survived

# Copy train and test to 
knn_train = train 
knn_test  = test
...
# Make the prediction objects for both models: 
...
#Evaluation methods, compact and separated groups (can be measured)   WSS  X BSS

#Dunn index (hight is better)
#min distance between clusters and max diameter within cluster


#Re-scale before standardize
...
run_km_sc = kmeans(run_record_sc, 5, nstart = 20) #. 5 groups, let R start over 20 times
